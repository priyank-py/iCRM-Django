...
class BillsInline(admin.StackedInline):
    model = Bill
    extra = 1
    fields = ['invoice', 'payment_option', 'credit_card_no', 'dd_no', 'cheque_no', 'drawn_on', 'add_fee', 'course_ware_fee', 'tution_fee', 'project_fee' , 'late_fee', 'exam_fee', 'other', 'sub_total', 'gst','g_total',  'amount_words']
